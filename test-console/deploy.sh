...
sed -i.tmp "s|from './lib/index.mjs'|from 'https://cdn.jsdelivr.net/npm/pwafire@latest/lib/index.mjs'|g" public/app.js
sed -i.tmp "s|from './lib/check/index.mjs'|from 'https://cdn.jsdelivr.net/npm/pwafire@latest/lib/check/index.mjs'|g" public/app.js
