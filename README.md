...
Get the [source code here](https://github.com/mayeedwin/pwafire/) PWA Fire and from [pwafire-bundle](https://github.com/mayeedwin/pwafire/tree/master/pwafire-bundle) folder, add the *service-worker.js* and *manifest.json*  files to the **ROOT** folder of your project or website.
